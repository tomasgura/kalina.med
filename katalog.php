...
<html>
    <head>
        ...
        <title>Druhy medu - Jindřích Kalina - Pražský med</title>
    </head>
    <body>
		<div class="content">
			...
			<div class="row">
				<div class="vlevo col-md-12">
					...
					<p>
						Aby byly zachovány přirozené vlastnosti medu, je nutné jej uchovávat v temnu a při teplotě do 25 stupňů Celsia. Zkrystalizovaný med můžeme opatrně rozehřát ve vodní lázni do teploty 45 stupňů Celsia. Nikdy nepoužíváme mikrovlnou troubu !!! Krystalizace medu je přirozená vlastnost medů s vyšším obsahem hroznového cukru - glukózy a je známkou kvality medu.

						Opakovaným zahřátím medu nad 50 stupňů Celsia dochází ke zničení enzymů a biologická hodnota klesá.
					</p>
				...
				<ximg class="vpravo" src="img/vcela.jpg">
			</div>
		</div>
